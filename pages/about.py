...
st.write("Beautify.ai uses AI and image processing to suggest the exact beauty and makeup products needed, based on a user's individual needs and preferences. The app provides step-by-step instructions on using the product, specifically insighting which area of the skin to apply, the quantity, and grooming tips. This feature is particularly helpful for individuals with neurogenerative disorders, who may need more guidance or structure when it comes to grooming and beauty routines.")


st.subheader("How we built it")

st.write("We built Beautify.ai using a combination of machine learning algorithms, image processing techniques, and user-centered design principles. We worked closely with individuals with neurogenerative disorders to ensure that the app would be accessible and easy to use for everyone.")
